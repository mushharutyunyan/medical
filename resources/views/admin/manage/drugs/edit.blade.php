                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                {{Form::text('trade_name_eng',$currentDrug->trade_name_eng,['class' => 'form-control','placeholder' => 'english name'])}}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                {{Form::text('category_'.$i,$categories->name,['class' => 'form-control'])}}
                                <?php $i++; ?>
                                @endforeach
                                {{Form::hidden('category',$currentDrug->categories->count(),['class' => 'form-control'])}}
                            </div>
                        </div>
                        <div class="form-group">
